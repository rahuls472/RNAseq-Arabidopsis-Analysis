...
The complete analysis pipeline was implemented using Linux, Bash scripting, NGS command-line tools, and R-based transcriptomic visualization.
...
The generated count matrix was used for exploratory differential expression analysis.
...
* Proper differential expression inference would require biological replicates and DESeq2/edgeR analysis
...
* RNA-seq visualization techniques
...
```text
Linux | Bash | RNA-seq | HISAT2 | SAMtools | featureCounts | R | Transcriptomics | NGS
```
...
LinkedIn: [https://www.linkedin.com/in/rahul-kumar-singh-1796b5332/](https://www.linkedin.com/in/rahul-kumar-singh-1796b5332/)

Portfolio: [http://codebyrahul.in](http://codebyrahul.in)
